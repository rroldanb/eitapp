        ...
        if not backup_file:
            ...
            try:
                ...
                try:
                    ...
                    call_command(
                        "migrate", database=target_database, no_input=True, run_syncdb=True
                    )
                    ...
                    try:
                        call_command(
                            "loaddata", tmp_path, database=target_database, ignorenonexistent=True
                        )
                    finally:
                    ...
                    if preserved_superuser:
                        ...
                        user, _ = UserModel.objects.using(target_database).update_or_create(
                ...
                if preserved_superuser:
                    ...
                    success_message += (
                        " Se eliminó toda la data ingresada después del respaldo seleccionado."
                    )
            except Exception as error:
                error_message = str(error)
    ...
    if request.method == "POST":
        ...
        if destino_tipo == "existente":
            ...
            proyecto_data = {
                ...
                "proyecto_date_started": p.date_started.strftime("%d/%m/%Y")
                if p.date_started
                else "",
        ...
        try:
            ...
            return render(
                ...
                "admin/migracion_gui.html",
                {
                    "error_message": f"Error durante la migración: {e!s}",
                    "proyectos": proyectos,
                    "mandantes": mandantes,
                },
            )
