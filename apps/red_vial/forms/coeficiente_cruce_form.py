...
class CoeficienteCruceForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "nomenclatura": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: VL"}
            ),
            "tipo_transporte": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: Vehículo Liviano"}
            ),
            "coeficiente": forms.NumberInput(
                attrs={"class": "form-control", "step": "0.01", "placeholder": "Ej: 1.0"}
            ),
