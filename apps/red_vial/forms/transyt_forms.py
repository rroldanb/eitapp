...
class ConfiguracionTransytForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'perdida_inicial': forms.NumberInput(attrs={
                'class': 'w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-indigo-500 bg-slate-50',
                'step': '0.1',
            }),
            'ganancia_final': forms.NumberInput(attrs={
                'class': 'w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-indigo-500 bg-slate-50',
                'step': '0.1',
            }),
        }
...
class ParametroArcoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'ponderador_demora': forms.NumberInput(attrs={
                'class': 'w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-indigo-500 bg-slate-50',
                'step': '0.01',
            }),
            'ponderador_detencion': forms.NumberInput(attrs={
                'class': 'w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-indigo-500 bg-slate-50',
                'step': '0.01',
            }),
            'capacidad_cola': forms.NumberInput(attrs={
                'class': 'w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-indigo-500 bg-slate-50',
                'step': '0.1',
            }),
            'tiene_tarjeta_38': forms.CheckboxInput(attrs={
...
class FaseSemaforicaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'verde_inicio': forms.NumberInput(attrs={
                'class': 'w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-indigo-500 bg-slate-50',
                'step': '0.1',
            }),
            'verde_fin': forms.NumberInput(attrs={
                'class': 'w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-indigo-500 bg-slate-50',
                'step': '0.1',
            }),
        }
