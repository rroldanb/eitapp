...
class PuntoControlForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'regulacion': forms.Select(attrs={'class': f'w-[5rem] {_select}', }),
            'numero_pistas': forms.NumberInput(attrs={
                'class': _input.replace('w-24', 'w-20'),
                'step': '0.5',
                'placeholder': 'Pistas',
            }),
            'interseccion': forms.NumberInput(attrs={'readonly': True, 'class': f'w-[5rem] {_input}'}),
            'vel_ini': forms.NumberInput(attrs={
                'class': _input.replace('w-24', 'w-20'),
                'readonly': True,
                'step': '0.1',
                'placeholder': '0',
            }),
            'vel_mod': forms.NumberInput(attrs={
                'class': _input.replace('w-24', 'w-20'),
                'readonly': True,
                'step': '1.0',
                'placeholder': '0',
