...
def regulaciones_list_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "red_vial/regulaciones_list.html", {"regulaciones": regulaciones})
...
def regulacion_create_view(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            regulacion_create(form.cleaned_data)
...
def regulacion_update_view(request: HttpRequest, regulacion_id: str) -> HttpResponse:
    ...
    return render(
        request, "red_vial/regulacion_form.html", {"form": form, "regulacion": regulacion}
    )
