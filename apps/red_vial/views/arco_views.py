...
from apps.red_vial.services.arco_service import (
    get_arcos_by_proyecto, create_arco, update_arco, delete_arco,
)
    ...
    def post(self, request, proyecto_id):
        ...
        if form.is_valid():
            try:
                ...
                response = render(request, 'partials/Arcos/arco_row.html', {
                    'arco': arco, 'proyecto': proyecto,
                ...
                response = render(request, 'partials/Arcos/arco_create.html', {
...
class ArcoUpdateView(View):
    ...
    def put(self, request, item_id):
        ...
        try:
            ...
            response = render(request, 'partials/Arcos/arco_row.html', {
                'arco': arco, 'proyecto': arco.proyecto,
