...
from apps.red_vial.services.calle_service import (
    get_calles_by_proyecto, create_calle, update_calle, delete_calle,
)
    ...
    def post(self, request: HttpRequest, proyecto_id: str) -> HttpResponse:
        ...
        if form.is_valid():
            try:
                ...
                response = render(request, 'partials/Calles/calle_row.html', {
                    'calle': calle, 'proyecto': proyecto,
                })
                response['HX-Trigger'] = 'calle-created'
                return response
            except (ValidationError, IntegrityError) as e:
                form.add_error(None, str(e))
                response = render(request, 'partials/Calles/calle_create.html', {
...
class CalleUpdateView(View):
    ...
    def put(self, request: HttpRequest, item_id: str) -> HttpResponse:
        ...
        try:
            ...
            response = render(request, 'partials/Calles/calle_row.html', {
                'calle': calle, 'proyecto': calle.proyecto,
            })
