...
from apps.red_vial.forms.transyt_forms import (
    ConfiguracionTransytForm,
    FaseSemaforicaForm,
    ParametroArcoForm,
)
...
from apps.red_vial.services.fase_semaforica_service import (
    create_fase_semaforica,
    delete_fase_semaforica,
    get_fases_by_proyecto,
    update_fase_semaforica,
)
from apps.red_vial.services.parametro_arco_service import (
    create_parametro_arco,
    delete_parametro_arco,
    get_parametros_by_proyecto,
    update_parametro_arco,
)
...
class ParametroArcoListView(ListView):
    ...
    sort_fields: list[str] = [
        "punto_control__nodo__numero_pc",
        "punto_control__movimiento",
        "flujo_saturacion",
        "ponderador_demora",
...
class ParametroArcoCreateView(View):
    ...
    def get(self, request: HttpRequest, proyecto_id: str) -> HttpResponse:
        ...
        return render(
            request,
            "partials/Transyt/parametro_arco_create.html",
            {
                "proyecto": proyecto,
                "form": form,
            },
    ...
    def post(self, request: HttpRequest, proyecto_id: str) -> HttpResponse:
        ...
        if form.is_valid():
            try:
                ...
                response = render(
                    request,
                    "partials/Transyt/parametro_arco_row.html",
                    {
                        "item": item,
                        "proyecto": proyecto,
                    },
...
class FaseSemaforicaListView(ListView):
    ...
    def get_queryset(self) -> QuerySet[FaseSemaforica]:
        ...
        if sort_by not in self.sort_fields:
            sort_by = self.default_sort
        return get_fases_by_proyecto(self.kwargs["proyecto_id"], sort_by=sort_by, order=sort_order)
...
class FaseSemaforicaCreateView(View):
    ...
    def get(self, request: HttpRequest, proyecto_id: str) -> HttpResponse:
        ...
        return render(
            request,
            "partials/Transyt/fase_semaforica_create.html",
            {
                "proyecto": proyecto,
                "form": form,
            },
    ...
    def post(self, request: HttpRequest, proyecto_id: str) -> HttpResponse:
        ...
        if form.is_valid():
            try:
                ...
                response = render(
                    request,
                    "partials/Transyt/fase_semaforica_row.html",
                    {
                        "item": item,
                        "proyecto": proyecto,
                    },
