...
class GenericListView(View):
    ...
    def get(self, request: HttpRequest, proyecto_id: str | None = None) -> HttpResponse:
        ...
        proyecto = get_object_or_404(
            self.model._meta.get_field("proyecto").related_model, id=proyecto_id
        )
    ...
    def put(self, request: HttpRequest, item_id: str, **kwargs: Any) -> HttpResponse:
        ...
        try:
            ...
            if self.form_class:
                kwargs = {}
                sig = inspect.signature(self.form_class.__init__)
                if "proyecto" in sig.parameters and hasattr(item, "proyecto") and item.proyecto:
...
class GenericBulkUpdateView(View):
    ...
    def post(self, request: HttpRequest, proyecto_id: str) -> HttpResponse:
        ...
        try:
            ...
            return JsonResponse(
                {"success": True, "updated_count": len(updated_ids), "updated_ids": updated_ids}
            )
