...
class CoeficientesCruceListView(ListView):
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        ctx["standard_coeficientes"] = CoeficienteCruce.objects.filter(
            is_standard=True, proyecto__isnull=True
        )
    ...
    def render_to_response(self, context: dict[str, Any], **response_kwargs: Any) -> HttpResponse:
        if self.request.headers.get("HX-Request"):
            return render(
                self.request, "partials/CoeficientesCruce/coeficientes_cruce_table.html", context
            )
...
class CoeficienteCruceCreateView(View):
    ...
    def get(self, request: HttpRequest) -> HttpResponse:
        return render(
            request,
            "partials/CoeficientesCruce/coeficiente_cruce_create.html",
            {
