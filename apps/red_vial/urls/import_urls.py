...
urlpatterns = [
    ...
    path(
        "proyecto/<uuid:proyecto_id>/importar/goto-selection/",
        import_goto_selection,
        name="import_goto_selection",
    ),
    path(
        "proyecto/<uuid:proyecto_id>/importar/back-config/",
        import_back_config,
        name="import_back_config",
    ),
    path(
        "proyecto/<uuid:proyecto_id>/importar/back-upload/",
        import_back_upload,
        name="import_back_step1",
    ),
